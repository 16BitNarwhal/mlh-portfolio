...
@app.route('/')
def index():
    about_section = "Hello! I'm Eric and I'm studying 💻 Software Engineering at the 🏫 University of Waterloo! I'm incredibly interested in 🤖 Machine Learning and I also love building out random 💡 ideas!"
    markers = [
